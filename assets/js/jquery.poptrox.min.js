            ...
            if ("ignore" != n && i.attr("href")) {
                ...
                switch (p = t.src.match(/\/\/[a-z0-9\.]+\/(.*)/), t.type) {
                    ...
                    case "bcove":
                        ...
                        break;
                    default:
                        if (t.object = e('<img src="" alt="" style="vertical-align:bottom" loading="lazy" style="height:200px; width:200px;"/>'), r.preload) {
                            var p = document.createElement("img");
                            p.src = t.src, f.push(p)
                        }
                        t.width = i.attr("width"), t.height = i.attr("height")
                }
                "file:" == window.location.protocol && t.src.match(/^\/\//) && (t.src = "https:" + t.src), d.push(t), s.removeAttr("title"), i.removeAttr("href").css("cursor", "pointer").css("outline", 0).on("click", function(e) {
